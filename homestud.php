...
<body style="color: #fff !important; font-weight: bolder; margin: 0 !important; font-family: 'Roboto', sans-serif; width: 100%;">
    <div style="background-color:rgb(27, 162, 211);height:auto;">
        ...
        <section style="margin-left: 3rem; height:3rem; display:grid; padding-top: 8px; padding-bottom: 3px; font-size: 1.5rem; font-family: 'Libre Baskerville', serif;"><a href="#" style="text-decoration: none; color: inherit;">Quiz Management System</a>
    <ul style="display: inline-flex;padding: 0 !important;margin-top: 0;float: right;right: 10rem;top:0.8rem;position: fixed;width: 50vw;">
             <li><a href="#" class="nav-link" onclick="dash()" style="text-decoration: none; color: inherit; cursor: pointer;">Dashboard</a></li>
                <li><a href="#" class="nav-link" onclick="prof()" style="text-decoration: none; color: inherit; cursor: pointer;">Profile</a></li>
                <li><a href="#" class="nav-link" onclick="score()" style="text-decoration: none; color: inherit; cursor: pointer;">Score</a></li>
                <li><a href="#" class="nav-link" onclick="toggleLeaderboard()" style="text-decoration: none; color: inherit; cursor: pointer;">Leaderboard</a></li>
                <li><a href="#" class="nav-link" onclick="lo()" style="text-decoration: none; color: inherit; cursor: pointer;">Sign Out</a></li>
            </ul>
            </section>
        </div><br><br>
        <?php
